...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(dasavefolder+'/images/intro/titlebg.png');
		bg.screenCenter();
		add(bg);
		...
		logoBl = new FlxSprite().loadGraphic(dasavefolder+'/images/intro/titlelogo.png');
		logoBl.screenCenter();
		...
		titleEnter = new FlxSprite().loadGraphic(dasavefolder+'/images/intro/titleenter.png');
		...
		BlackTransition = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, FlxColor.BLACK);
		add(BlackTransition);
	...
	override function update(elapsed:Float)
	{
		...
		if(logoBl != null)
			logoBl.scale.set(bumpScale, bumpScale);

		bumpScale = FlxMath.lerp(1, bumpScale, CoolUtil.boundTo(1 - (elapsed * 9), 0, 1));
