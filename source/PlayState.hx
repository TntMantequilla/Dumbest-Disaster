...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (isStoryMode && (SONG.song.toLowerCase() != 'dumber' || SONG.song.toLowerCase() != 'dumbest')) storyDifficultyText = 'Hard';
	...
	override public function update(elapsed:Float)
	{
		...
		if (controls.PAUSE && startedCountdown && canPause && FlxG.sound.music.time > 0)
		{
			...
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
				{
					...
					if(!ClientPrefs.getGameplaySetting('practice', false) && !ClientPrefs.getGameplaySetting('botplay', false)) {
						...
						if (!FlxG.save.data.ModCompleted)
						{
							FlxG.save.data.ModCompleted = true;
							FlxG.save.data.SettedFolder = true;
						}
				...
				else
				{
					...
					if (SONG.song == 'dumber') difficulty = '-Hard';
